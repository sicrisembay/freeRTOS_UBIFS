...
#if 0 /* #if CONFIG_IS_ENABLED(PARTITION_UUIDS) is not set */
...
#if 0 /* #if CONFIG_IS_ENABLED(EFI_PARTITION) is not set */
#include <part_efi.h>
/* disk/part_efi.c */
/**
...
#if 0 /* #if CONFIG_IS_ENABLED(DOS_PARTITION) is not set */
/**
